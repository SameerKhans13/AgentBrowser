...
export declare const agentRuns: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    dialect: "pg";
}>, runStatusEnum: import("drizzle-orm/pg-core").PgEnum<["PENDING", "RUNNING", "COMPLETED", "FAILED"]>, actionTypeEnum: import("drizzle-orm/pg-core").PgEnum<["OPEN_BROWSER", "GOTO_URL", "SCREENSHOT", "CLICK", "SEND_KEYS", "SCROLL", "DOUBLE_CLICK", "FINISH", "ERROR"]>;
